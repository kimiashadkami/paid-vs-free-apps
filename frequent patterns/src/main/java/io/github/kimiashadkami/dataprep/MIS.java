    ...
    public void generateMIS(String dir_write, int k) {
        ...
        try {
            ...
            for (int i = 0; i < 49; i++) {
                ...
                buffered_writer.append(Integer.toString((int) (k * 0.02)));
                buffered_writer.append("\n");
            }
            for (int i = 49; i < 53; i++) {
                buffered_writer.append(Integer.toString(i));
            ...
            for (int i = 53; i < 75; i++) {
                buffered_writer.append(Integer.toString(i));
                buffered_writer.append(" ");
                buffered_writer.append(Integer.toString((int) (k * 0.045)));
                buffered_writer.append("\n");
            }
            for (int i = 75; i < 79; i++) {
                buffered_writer.append(Integer.toString(i));
            ...
            for (int i = 83; i < 91; i++) {
                buffered_writer.append(Integer.toString(i));
                buffered_writer.append(" ");
                buffered_writer.append(Integer.toString((int) (k * 0.12)));
                buffered_writer.append("\n");
            }
            for (int i = 91; i < 97; i++) {
                buffered_writer.append(Integer.toString(i));
                buffered_writer.append(" ");
                buffered_writer.append(Integer.toString((int) (k * 0.16)));
                buffered_writer.append("\n");
            }
            ...
            for (int i = 2010; i < 2022; i++) {
                buffered_writer.append(Integer.toString(i));
                buffered_writer.append(" ");
                buffered_writer.append(Integer.toString((int) (k * 0.08)));
                buffered_writer.append("\n");
            }
