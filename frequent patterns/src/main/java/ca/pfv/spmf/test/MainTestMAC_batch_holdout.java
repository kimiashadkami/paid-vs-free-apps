...
/**
 * Example of how to run the MAC algorithm
 * 
 * @author Philippe Fournier-Viger, 2021
 *
 */
public class MainTestMAC_batch_holdout {
...
//		dataset.printStringRepresentation();
		...
		ClassificationAlgorithm[] algorithms = new ClassificationAlgorithm[] { algorithmMAC };
	...
	public static String fileToPath(String filename) throws UnsupportedEncodingException {
		URL url = MainTestMAC_batch_holdout.class.getResource(filename);
