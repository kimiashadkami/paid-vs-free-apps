 ...
 *
 */
public class MainTestADT_single_prediction {
...
//		dataset.printStringRepresentation();
		...
		Classifier classifier = new AlgoADT(minConf, minMerit).trainAndCalculateStats(dataset);
...
//		classifier = Classifier.loadTrainedClassifierToFile("classifier.ser");
	...
	public static String fileToPath(String filename) throws UnsupportedEncodingException {
		URL url = MainTestADT_single_prediction.class.getResource(filename);
