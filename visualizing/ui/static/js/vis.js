...
function BarChart(data, strname, {
    ...
    //the next two lines are my own code for dynamic element creation
    ...
    //last line is my own code for font
...
function generate_cards(str){
    //generate cards
    var str_no_underline = str.replaceAll("_", " ");
...
function visualize_pattern(patterns_data, str){

    const patterns_vis = []
    for(let i = 0; i < patterns_data.length; i++){
        patterns_vis.push({
            "name" : patterns_data[i]["dataset"],
            "value" : patterns_data[i]["frequency"]
        });
    }
    ...
    chart = BarChart(patterns_vis, str, {
        x: d => d.name,
        y: d => d.value,
        yFormat: "%",
        yLabel: "↑ Frequency",
...
function visualize_category(data, str){
    ...
    chart = BarChart(vis_data_top, str, {
        x: d => d.name,
        y: d => d.value,
        yFormat: "%",
        yLabel: "↑ Frequency",
