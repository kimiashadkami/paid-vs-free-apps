...
/**
 * This class describes the HUIM-AF algorithm parameters. 
 * It is designed to be used by the graphical and command line interface.
 * 
 * @see AlgoHUIM_GA
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoHUIM_AF extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoHUIM_AF(){
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/HUIM-AF.php";
	}
	...
	public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws IOException {
		...
		AlgoHUIM_AF algo = new AlgoHUIM_AF();
	...
	public String getImplementationAuthorNames() {
		return "Wei Song, Junya Li, Chaomin Huang";
	}
