 ...
 *
 */
public class MainTestCBA_single_prediction {
...
//		dataset.printStringRepresentation();
		...
		Classifier classifier = new AlgoCBA(minSup, minConf, false).trainAndCalculateStats(dataset);
...
//		classifier = Classifier.loadTrainedClassifierToFile("classifier.ser");
	...
	public static String fileToPath(String filename) throws UnsupportedEncodingException {
		URL url = MainTestCBA_single_prediction.class.getResource(filename);
