 ...
 *
 */
public class MainTestACCF_single_prediction {
...
//		dataset.printStringRepresentation();
		...
		Classifier classifier = new AlgoACCF(minSup, minConf).trainAndCalculateStats(dataset);
...
//		classifier = Classifier.loadTrainedClassifierToFile("classifier.ser");
	...
	public static String fileToPath(String filename) throws UnsupportedEncodingException {
		URL url = MainTestACCF_single_prediction.class.getResource(filename);
