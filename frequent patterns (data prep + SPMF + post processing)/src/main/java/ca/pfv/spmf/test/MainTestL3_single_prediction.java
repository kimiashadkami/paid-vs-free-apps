...
/**
 * Example of how to run the L3 algorithm
 * 
 * @author Philippe Fournier-Viger, 2021
 *
 */
public class MainTestL3_single_prediction {
...
//		dataset.printStringRepresentation();
		...
		Classifier classifier = new AlgoL3(minSup, minConf).trainAndCalculateStats(dataset);
...
//		classifier = Classifier.loadTrainedClassifierToFile("classifier.ser");
	...
	public static String fileToPath(String filename) throws UnsupportedEncodingException {
		URL url = MainTestL3_single_prediction.class.getResource(filename);
