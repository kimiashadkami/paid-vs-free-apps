...
/**
 * Example of how to run the ADT algorithm
 * 
 * @author Philippe Fournier-Viger, 2021
 *
 */
public class MainTestADT_batch_holdout {
...
//		dataset.printStringRepresentation();
		...
		ClassificationAlgorithm algorithmADT = new AlgoADT(minConf, minMerit);
		...
		ClassificationAlgorithm[] algorithms = new ClassificationAlgorithm[] { algorithmADT };
	...
	public static String fileToPath(String filename) throws UnsupportedEncodingException {
		URL url = MainTestADT_batch_holdout.class.getResource(filename);
